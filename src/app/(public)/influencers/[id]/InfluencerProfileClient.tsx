...
import { ArrowLeft, ArrowRight, Play, Eye, ChevronLeft, ChevronRight, Share2, X } from "lucide-react";
  ...
  return (
    <div className={styles.container}>
      ...
      <ShareModal
        ...
        metaText={`👥 ${formatStatNumber(totalFollowers)} Followers • 📍 ${profile.cities?.name || "Mangalore"}`}
      />
    </div>
  );
}
