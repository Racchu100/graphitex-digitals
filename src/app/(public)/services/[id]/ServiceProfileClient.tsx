...
import { ArrowLeft, Play, ExternalLink, MessageCircle, Phone, ChevronLeft, ChevronRight, Share2, Copy, Check, X } from "lucide-react";
    ...
    if (typeof navigator !== "undefined" && (navigator as any).share) {
      try {
        await (navigator as any).share({
          title: `${profile.business_name} - Service Details`,
          text: shareText,
          url: currentUrl,
        });
      } catch (err) {
        ...
        <div className={styles.modalOverlay} onClick={() => setShowShareModal(false)}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              <h3 className={styles.modalTitle}>Share Service</h3>
