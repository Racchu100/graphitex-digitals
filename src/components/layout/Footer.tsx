      ...
      <div className={`container ${styles.footerGrid}`}>
        ...
        <div className={styles.brandCol}>
          ...
          <div className={styles.socials}>
            <a href="https://instagram.com/graphitex_digitals" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <a href="https://wa.me/919187336058" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
              <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className={styles.linksCol}>
          ...
          <ul className={styles.linksList}>
            ...
            <li>
              <a href="https://wa.me/919187336058" target="_blank" rel="noopener noreferrer">Contact Support</a>
            </li>
            <li>
        ...
        <div className={styles.linksCol}>
          ...
          <ul className={styles.contactList}>
            ...
            <li>
              ...
              <span>graphitexdigitals@gmail.com</span>
            </li>
            <li>
